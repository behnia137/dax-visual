...
DATEADD is the most flexible time intelligence function. SAMEPERIODLASTYEAR is just `DATEADD('Date'[Date], -1, YEAR)`, a convenience wrapper. DATEADD is worth learning first because once you understand it, every other time intelligence function is a variation on the same theme.
